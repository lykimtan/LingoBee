    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 pb-12">
      ...
      {!isLoading && !error && course && (
        <div className="grid items-start gap-6 lg:grid-cols-[280px_1fr]">
          {/* Sidebar */}
          <div className="flex flex-col gap-2 rounded-3xl border border-gray-100 bg-white p-3 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
            ...
            <nav className="flex flex-col gap-1">
              <button className="flex items-center gap-3 rounded-xl bg-[#111827] px-4 py-3.5 text-sm font-semibold text-white shadow-md">
                <BarChart2 className="h-5 w-5 opacity-80" />
                Course Statistics
              </button>
              <button className="flex items-center gap-3 rounded-xl px-4 py-3.5 text-sm font-semibold text-gray-600 transition-colors hover:bg-gray-50">
            ...
            <div className="mt-2 px-1 pb-1">
              <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-black px-4 py-3.5 text-sm font-bold text-white shadow-md transition-colors hover:bg-gray-900">
