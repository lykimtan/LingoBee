...
const TABS = ["Tổng quan", "Tài liệu", "Ghi chú cá nhân", "Thảo luận"];
...
export const LearningInterface = ({ slug, initialVideoId }: LearningInterfaceProps) => {
  ...
  const renderActiveTab = () => {
    switch (activeTab) {
      ...
      case "Ghi chú cá nhân": return <NotesTab />;
      case "Thảo luận": return <DicussionTab />;
      ...
      <div className="mx-auto max-w-[1600px] p-4 lg:p-6 lg:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8 items-start">
          ...
          <div className="flex flex-col gap-6 sticky top-24">
            <div className="rounded-2xl liquid-glass p-6 shadow-xl">
